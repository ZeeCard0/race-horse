...
export default function GameSettings() {
  const { setDistance, distance, isSearchParamReaded } = useArena();
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 font-mono">
        <div className="flex flex-col items-center w-xs bg-gray-700 rounded-2xl shadow-md shadow-gray-600 overflow-hidden">
